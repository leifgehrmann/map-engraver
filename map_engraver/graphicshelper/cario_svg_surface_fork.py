...
# ## START OF FORK ## #
from cairosvg.colors import color, negate_color
from cairosvg.defs import (
...
from cairosvg.helpers import (
    UNITS, PointError, clip_rect, node_format, normalize, paint,
    preserve_ratio, size, transform)
from cairosvg.image import image, invert_image
from cairosvg.parser import Tree
from cairosvg.path import draw_markers, path
from cairosvg.shapes import circle, ellipse, line, polygon, polyline, rect
from cairosvg.svg import svg
from cairosvg.text import text
...
class Surface(object):
    ...
    def __init__(self, tree, output, dpi, parent_surface=None,
                 ...
                 output_cairo=None, output_cairo_context=None):
        # ## END OF FORK ## #
